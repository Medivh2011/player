...
#define FFMPEG_CONFIGURATION "--prefix=./output/arm64-v8a --cc=/home/emiji/ndk/android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang --nm=/home/emiji/ndk/android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android-nm --ar=/home/emiji/ndk/android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android-ar --ld=/home/emiji/ndk/android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android21-clang --enable-cross-compile --enable-shared --disable-static --enable-pthreads --enable-gpl --enable-nonfree --disable-stripping --enable-zlib --enable-network --enable-thumb --enable-swscale --enable-hwaccels --enable-inline-asm --enable-version3 --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-symver --enable-avdevice --enable-avfilter --enable-small --enable-asm --enable-neon --cross-prefix=/home/emiji/ndk/android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android- --target-os=android --arch=aarch64 --enable-runtime-cpudetect --sysroot=/home/emiji/ndk/android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/sysroot --disable-libmfx --disable-encoder=h264_qsv --disable-decoder=h264_qsv --enable-parsers --enable-encoders --enable-demuxers --enable-muxers --enable-filters --enable-protocols --enable-protocol=concat --enable-protocol=hls --enable-protocol=file --enable-libmp3lame --enable-libfdk-aac --enable-encoder=libfdk-aac --enable-encoder=libx264 --enable-libx264 --extra-cflags='-I/home/emiji/workspace/lame/libs/ -I/home/emiji/workspace/fdk-aac/include/ -I/home/emiji/workspace/x264/jni/x264-master/output/arm64-v8a/include -DBIONIC_IOCTL_NO_SIGNEDNESS_OVERLOAD -Os -fPIC ' --extra-ldflags='-L/home/emiji/workspace/lame/libs/arm64-v8a -L/home/emiji/workspace/fdk-aac/fdk-aac-2.0.2/output/arm64-v8a/lib -L/home/emiji/workspace/x264/jni/x264-master/output/arm64-v8a/lib'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "./output/arm64-v8a/share/ffmpeg"
#define AVCONV_DATADIR "./output/arm64-v8a/share/ffmpeg"
...
#define CONFIG_CHANNELMORE_FILTER 1
